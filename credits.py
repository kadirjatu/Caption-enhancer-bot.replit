...
# ── Beta Mode — change to False after official launch ─────────────────────────
BETA_MODE       = True   # During Beta: all features free
CREDITS_ENABLED = False  # During Beta: no credits deducted
...
def deduct_credits(user_id, amount):
    ...
    No-op during Beta Mode when CREDITS_ENABLED is False."""
